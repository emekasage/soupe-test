...
function AllOrders() {
  return (
    <div style={{ fontFamily: "Open Sans, sans-serif" }}>
      <Head>
        <title>Soupe - Farmer | Transactions</title>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2.5 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-600 bg-opacity-10 text-yellow-800">
                            Pending
                          </span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2.5 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-600 bg-opacity-10 text-red-800">
                            Returned
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2.5 py-1.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-600 bg-opacity-10 text-green-800">
                            Delivered
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
