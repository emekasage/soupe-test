  ...
  return (
    ...
    >
      ...
      <div className="sm:mx-16 md:mx-40 lg:mx-10 xl:mx-20 sm:my-4 md:my-16 sm:block lg:flex justify-between items-center">
        <div className={`log-side-txt h-one max-w-lg ${pageStyles.mobheading}`}>
          <h4
        ...
        <div className={`sm:ml-8 lg:mr-8 max-w-sm ${pageStyles.mobform}`}>
          <div className="log-top-txt h-one pb-3">
            <h6 className="text-2xl font-bold">Welcome</h6>
            <p
          ...
          <form className="p-text mt-6">
            ...
            <div className="flex justify-between w-full">
              <div className="flex items-center items-start py-8">
                <input
                  id="checkbox-2"
              ...
              <div className="text-sm font-normal" style={{ color: "#8692A6" }}>
